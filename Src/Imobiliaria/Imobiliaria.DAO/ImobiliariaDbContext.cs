...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-T6MOFA0;Database=ImobiliariaDB;User Id=sa;Password=1q2w3e4r@#$;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.ClienteId).HasName("PK__Clientes__71ABD087646E62EA");

            entity.HasIndex(e => e.Cpf, "UQ__Clientes__C1F89731612A0B58").IsUnique();
        ...
        {
            entity.HasKey(e => e.CorretorId).HasName("PK__Corretor__4878C58F31732228");

            entity.HasIndex(e => e.Cpf, "UQ__Corretor__C1F8973168195413").IsUnique();

            entity.HasIndex(e => e.Creci, "UQ__Corretor__C466740974CA7258").IsUnique();
        ...
        {
            entity.HasKey(e => e.FavoritoId).HasName("PK__Favorito__CFF711E58B2332E4");
        ...
        {
            entity.HasKey(e => e.ImovelId).HasName("PK__Imoveis__68DA341CD6436C59");
        ...
        {
            entity.HasKey(e => e.MensagemId).HasName("PK__Mensagen__7C0322C6A1843657");
